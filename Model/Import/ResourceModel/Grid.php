...
class Grid extends \Magento\Framework\View\Element\UiComponent\DataProvider\SearchResult
{
    ...
    public function __construct(
        ...
        $mainTable = \Mavenbird\ProductAttachment\Setup\Operation\CreateImportTable::TABLE_NAME,
        $resourceModel = \Mavenbird\ProductAttachment\Model\Import\ResourceModel\Import::class
    ) {
