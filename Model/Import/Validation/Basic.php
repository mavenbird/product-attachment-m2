...
namespace Mavenbird\ProductAttachment\Model\Import\Validation;

use Mavenbird\Core\Model\Import\Validation\Validator;
...
class Basic extends Validator implements \Mavenbird\Core\Model\Import\Validation\ValidatorInterface
{
    ...
    /**
     * @var \Mavenbird\ProductAttachment\Model\Import\Repository
     */
     ...
     * @param \Mavenbird\ProductAttachment\Model\Import\Repository $importRepository
     */
    public function __construct(
        \Magento\Framework\DataObject $validationData,
        \Mavenbird\ProductAttachment\Model\Import\Repository $importRepository
    ) {
